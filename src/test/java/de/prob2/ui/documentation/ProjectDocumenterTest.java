...
class ProjectDocumenterTest {
	...
	void testBlankDocument() throws IOException {
		ProjectDocumenter velocityDocumenter1 = new ProjectDocumenter(project, TEST_LOCALE, i18n, false, false, false, false, machines, outputPath, outputFilename);
	...
	void testMachineCodeAndTracesInserted() throws IOException {
		...
		ProjectDocumenter velocityDocumenter = new ProjectDocumenter(project, TEST_LOCALE, i18n, false, false, false, false, machines, outputPath, outputFilename);
		velocityDocumenter.documentVelocity();
	...
	void testModelchecking() throws IOException {
		machines.add(trafficLight);
		ProjectDocumenter velocityDocumenter = new ProjectDocumenter(project, TEST_LOCALE, i18n, true, false, false, false, machines, outputPath, outputFilename);
		velocityDocumenter.documentVelocity();
	...
	void testLTL() throws IOException {
		machines.add(trafficLight);
		ProjectDocumenter velocityDocumenter = new ProjectDocumenter(project, TEST_LOCALE, i18n, false, true, false, false, machines, outputPath, outputFilename);
		velocityDocumenter.documentVelocity();
	...
	void testSymbolic() throws IOException {
		machines.add(trafficLight);
		ProjectDocumenter velocityDocumenter = new ProjectDocumenter(project, TEST_LOCALE, i18n, false, false, true, false, machines, outputPath, outputFilename);
		velocityDocumenter.documentVelocity();
	...
	void testPDFCreated() throws Exception {
		ProjectDocumenter velocityDocumenter = new ProjectDocumenter(project, TEST_LOCALE, i18n, false, false, false, true, machines, outputPath, outputFilename);
		Process p = velocityDocumenter.documentVelocity().orElseThrow();
