...
public class NewEditDynamicFormulaStage extends Stage {

	@FunctionalInterface
	public interface DynamicFormulaTaskFactory {
		DynamicFormulaTask createTask(String id, String formula);
	}
	...
	private DynamicFormulaTask result;

	@Inject
	public NewEditDynamicFormulaStage(final StageManager stageManager, final I18n i18n, final CurrentProject currentProject) {
		this.i18n = i18n;
	...
	public void setInitialFormulaTask(DynamicFormulaTask item, ObservableList<ErrorItem> errors, DynamicFormulaTaskFactory factory) {
	...
	public DynamicFormulaTask getResult() {
		return this.result;
	}
}
