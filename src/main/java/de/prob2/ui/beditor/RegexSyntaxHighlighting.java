...
public final class RegexSyntaxHighlighting {
	...
	static {
		...
		var tokenClassesForRulesDSL = List.of(
				...
				new TokenClass("editor_ctrlkeyword", compile("RULE_FORALL|RULE_FAIL|RULEID|RULE|DEPENDS_ON_RULE|DEPENDS_ON_COMPUTATION|ACTIVATION|REPLACES|ERROR_TYPES|CLASSIFICATION|TAGS|BODY|EXPECT|ERROR_TYPE|ON_SUCCESS|UNCHECKED|COUNTEREXAMPLE|COMPUTATION|DEFINE|TYPE|DUMMY_VALUE|VALUE|FUNCTION|PRECONDITION|POSTCONDITION|FOR", U)),
		...
		var tokenClassesForXTL = List.of(
				new TokenClass("editor_keyword", compile("start|symb_trans_enabled|symb_trans|trans_prop|trans|prop|heuristic_function_result|heuristic_function_active|nr_state_properties|prob_pragma_string|animation_(?:function_result|image_right_click_transition|image_click_transition|image)")),
