...
public class PreferenceValueCell extends TreeTableCell<PrefTreeItem, String> {
	...
	public PreferenceValueCell(final ReadOnlyObjectProperty<ProBPreferences> preferences) {
		super();
