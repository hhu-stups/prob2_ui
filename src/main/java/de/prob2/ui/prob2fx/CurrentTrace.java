...
public final class CurrentTrace extends SimpleObjectProperty<Trace> {
	...
	@Inject
	private CurrentTrace(final AnimationSelector animationSelector, final CurrentState currentState,
			final CurrentStateSpace currentStateSpace, final CurrentModel currentModel) {
		super(null);
