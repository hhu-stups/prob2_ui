...
import de.prob2.ui.operations.Operation;
import de.prob2.ui.operations.OperationsView;
import de.prob2.ui.operations.TransitionTransformer;
...
public class HistoryView extends TitledPane implements Initializable, ITraceChangesListener {
	...
	public void changed(List<Trace> t) {
		...
		try {
			...
			//int endpos = opList.size() > currentPos + 20 ? currentPos + 20 : opList.size();
